...
function apply(ctx, config = {}) {
	...
	disposers.push(tools.register({
			name: 'preview_image',
			description: 'Make an existing local image file viewable inline in the chat: copy it into the preview directory served at http://127.0.0.1:<port>/preview/ and return its URL. Use after producing or downloading an image (e.g. a website screenshot) so the user can see it directly in the conversation.',
			parameters: {
				type: 'object',
				properties: {
					file_path: {
